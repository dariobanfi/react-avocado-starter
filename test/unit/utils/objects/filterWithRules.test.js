import filterWithRules from '../../../../app/utils/objects/filterWithRules';

describe('filterWithRules', () => {
  test('throws an exception if rules is not an object', () => {
    const filterRules = 'something else';
    const obj = { a: 1, b: 2 };
  ...
  test('applies filtering on nested objects', () => {
    const filterRules = { a: { something: true }, b: true };
